package org.example.backendbasesecurity.service;
...
import org.example.backendbasesecurity.repository.UserRepository;
...
public class UserService implements UserDetailsService {
    ...
    @PostConstruct
    public void init() {
        this.save(new UserCreateRequestDto("aaron", passwordEncoder.encode("123"), "Aaron", 10,
            "DEVELOPER", "Backend"));
        this.save(new UserCreateRequestDto("baron", passwordEncoder.encode("123"), "Baron", 20,
            "DEVELOPER", "Frontend"));
        this.save(new UserCreateRequestDto("caron", passwordEncoder.encode("123"), "Caron", 30,
            "ENGINEER", "DevOps/SRE"));
    }
